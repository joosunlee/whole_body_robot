...
double past_wheel_theta_fl = 0;
double past_wheel_theta_rl = 0;
double past_wheel_theta_rr = 0;
double past_wheel_theta_fr = 0;
...
double Vx  = 0;
double Vy  = 0;
double steer_angular_vel = 0;

double past_act_angle = 0;
